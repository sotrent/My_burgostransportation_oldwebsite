...
<body class="short-header-page  wsite-theme-light  wsite-page-contact"><input type="checkbox" id="mobile-trigger" class="mobile-trigger">
...
<? $tipo=$_GET['tipo']; $zona=$_GET['zona']; $cod=$_GET['folios'];   $cad="formSubmit.php?area=csh&code=".$cod;  ?>

<h2 class="wsite-content-title" style="text-align:left;">Payment Method!</h2>

<div class="paragraph" style="font-weight:bold">Your Confirmation Code:<? echo " ".$cod; ?></div>
<br/> 
<br/> <br/> 


<div>&emsp;
    <a class="wsite-button wsite-button-small wsite-button-highlight" href="<? echo $cad; ?>"  >
       <span class="wsite-button-inner">Cash!</span>
     </a>
</div>
<br/> 
<br/> <br/> 
...
<div>
<? if($zona=="San Jose del Cabo"){    
   if($tipo==2){ ?>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="D836Z5ZVW44KL">
...
<?   if($zona=="Puerto los Cabos"){    
 if($tipo==2){ ?>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="YT4NP9RNJFCHA">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_paynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/es_XC/i/scr/pixel.gif" width="1" height="1">
</form>
   <?  }else{  ?>
...
<?   if($zona=="Bahia de los Sueños Area"){    
 if($tipo==2){ ?>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="YT4NP9RNJFCHA">
...
<div style="display:none">
				<form enctype="multipart/form-data" action="formSubmit.php?accion=contact"	method="POST">
				...
				<div><div class="wsite-form-field wsite-name-field" style="margin:5px 0px 5px 0px;">
				       ...
				       <div class="wsite-form-input-container wsite-form-left wsite-form-input-first-name">
					     <input id="input-567119249953419379" class="wsite-form-input wsite-input" type="text" name="nom" placeholder="First Name" required="required" />				
				       </div>
				       <div class="wsite-form-input-container wsite-form-right wsite-form-input-last-name">
				         <input class="wsite-form-input wsite-input" type="text" name="nom2" placeholder="Last Name" required="required" />
				       </div>
			          </div>
			          <div style="clear:both;"></div>
			     </div>
                 <div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
				        ...
				        <div class="wsite-form-input-container">
					      <input class="wsite-form-input wsite-input wsite-input-width-370px" type="email" name="mail" required="required" />
				        </div>
		     		   </div>
		         </div>
                 <div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
				        <label class="wsite-form-label" for="input-645204825494571506">Message <span class="form-required">*</span></label>
				        <div class="wsite-form-input-container">
					      <textarea class="wsite-form-input wsite-input wsite-input-width-370px" name="mensaje" style="height: 100px" required="required"></textarea>
				        </div>				
			     </div></div>
				 </ul>
				 </div>
